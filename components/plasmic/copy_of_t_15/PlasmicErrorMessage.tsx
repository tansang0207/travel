...
import sty from "./PlasmicErrorMessage.module.css"; // plasmic-import: WFX4i-RTkMfc/css
    ...
    () => [
      {
        ...
        initFunc: ({ $props, $state, $queries, $ctx }) => $props.isVisible
      }
    ],
    [$props, $ctx, $refs]
  );
  ...
  return (
    <div
      ...
      className={classNames(
        ...
        sty.root,
        { [sty.rootisVisible]: hasVariant($state, "isVisible", "isVisible") }
      )}
    >
      {
        "Please verify you've entered correctly your checkin/checkout preference."
      }
    </div>
