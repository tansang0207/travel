...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: EoLK6dRhWkxB/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: mpKzvwItFntM/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__ol1X)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__rdtEn)}
              />
            </React.Fragment>
          ),
          value: args.children
